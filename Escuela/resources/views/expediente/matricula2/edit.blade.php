		...
		<div class="form-group col-md-3">
			<label>Sexo</label></br>
				@if ($estudiante->sexo == 'F')
					<label>{!! Form::radio('sexo',0,true, ['disabled'=>'on']) !!} Femenino</label>
					<label>{!! Form::radio('sexo',1,false, ['disabled'=>'on']) !!} Masculino</label>
				@else
					<label>{!! Form::radio('sexo',0,false, ['disabled'=>'on']) !!} Femenino</label>
					<label>{!! Form::radio('sexo',1,true, ['disabled'=>'on']) !!} Masculino</label>
				@endif
		</div>
		<div class="form-group col-md-3">
