        ...
        ?>
            ...
            <tr role="row" class="odd">
                ...
                <td><?= $usuario->created_at;  ?></td>
                 <td>
                 <a  href="form_editar_usuario/{{$usuario->id}}" class="btn btn-info"><i class="fa fa-edit"> Editar</i></a></td>
                 <td><form action="{{ url('eliminar')}}/{{$usuario->id}}" method="post">
                 {{ csrf_field() }}{{ method_field('DELETE') }}
                <button type="submit" action="" class="btn btn-danger"><i class="fa fa-trash"> Eliminar</i></button></td>      
            </tr>
        </tbody>
<?php        
}
